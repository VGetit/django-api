...
from api.models import Company, Address, PhoneNumber, Contacts, trigger_address_verification
    ...
    def handle(self, *args, **options):
        ...
        try:
            with open(csv_file, 'r', encoding='utf-8') as file:
                ...
                post_save.disconnect(trigger_address_verification, sender=Company)
                ...
                post_save.connect(trigger_address_verification, sender=Company)
